...
class DataUseField(metaclass=IntEnumFieldMeta, enum=DataUse):
    pass
...
class ScalarFactorField(metaclass=IntEnumFieldMeta, enum=ScalarFactor):
    pass
...
class CoordinateUnitsField(metaclass=IntEnumFieldMeta, enum=CoordinateUnits):
    pass
...
class CorrelatedField(metaclass=IntEnumFieldMeta, enum=Correlated):
    pass
...
class SweepTypeField(metaclass=IntEnumFieldMeta, enum=SweepType):
    pass
...
class TaperTypeField(metaclass=IntEnumFieldMeta, enum=TaperType):
    pass


class DayOfYearField(
    metaclass=IntFieldMeta, seg_y_type="int16", min_value=0, max_value=366
):
...
class HourOfDayField(
    metaclass=IntFieldMeta, seg_y_type="int16", min_value=0, max_value=24
):
...
class MinuteOfHourField(
    metaclass=IntFieldMeta, seg_y_type="int16", min_value=0, max_value=60
):
    "Minute of hour."
...
class TimeBasisCodeField(metaclass=IntEnumFieldMeta, enum=TimeBasisCode):
    pass
...
class OverTravelField(metaclass=IntEnumFieldMeta, enum=OverTravel):
    pass
...
class SampleUnitField(metaclass=IntEnumFieldMeta, enum=SampleUnit):
    pass


class SourceTypeField(metaclass=IntFieldMeta, seg_y_type="int16", max_value=9):
...
class SourceMeasurementUnitField(
    metaclass=IntEnumFieldMeta, enum=SourceMeasurementUnit
):
    pass
...
class TraceHeaderRev0(Header):
    ...
    line_sequence_num = field(
        ...
        offset=1,
        default=0,
        documentation="""Trace sequence number within line — Numbers continue to increase if the same
    ...
    file_sequence_num = field(
        ...
        offset=5,
        default=0,
        documentation="Trace sequence number within SEG Y file — Each file starts with trace sequence one.",
    )
    ...
    field_record_num = field(
        ...
        offset=9,
        default=0,
        documentation="Original field record number. Highly recommended for all types of data.",
    )
    ...
    trace_num = field(
        ...
        offset=13,
        default=0,
        documentation="Trace number within the original field record. Highly recommended for all types of data.",
    )
    ...
    energy_source_point_num = field(
        ...
        offset=17,
        default=0,
        documentation="""Energy source point number — Used when more than one record occurs at the
    ...
    ensemble_trace_num = field(
        ...
        offset=25,
        default=0,
        documentation="Trace number within the ensemble — Each ensemble starts with trace number one.",
    )
    ...
    num_vertically_summed_traces = field(
        ...
        offset=31,
        default=1,
        documentation="Number of vertically summed traces yielding this trace. (1 is one trace, 2 is two summed traces, etc.)",
    )
    ...
    num_horizontally_stacked_traces = field(
        ...
        offset=33,
        default=1,
        documentation="Number of horizontally stacked traces yielding this trace. (1 is one trace, 2 is two stacked traces, etc.)",
    )

    data_use = field(DataUseField, offset=35, default=1, documentation=DataUse.__doc__)

    doc_nreceiver_offset = field(
        Int32,
        offset=37,
        default=0,
        documentation="""Distance from center of the source point to the center of the receiver group
    ...
    receiver_group_elevation = field(
        ...
        offset=41,
        default=0,
        documentation="""Receiver group elevation (all elevations above the Vertical datum are
    ...
    surface_elevation_at_source = field(
        ...
        offset=45,
        default=0,
        documentation="Surface elevation at source. The elevation_scalar applies to this value.",
    )
    ...
    source_depth_below_surface = field(
        ...
        offset=49,
        default=0,
        documentation="Source depth below surface (a positive number). The elevation_scalar applies to this value.",
    )
    ...
    datum_elevation_at_source = field(
        ...
        offset=57,
        default=0,
        documentation="Datum elevation at source. The elevation_scalar applies to this value.",
    )
    ...
    water_depth_at_source = field(
        ...
        offset=61,
        default=0,
        documentation="Water depth at source. The elevation_scalar applies to this value.",
    )
    ...
    water_depth_at_group = field(
        ...
        offset=65,
        default=0,
        documentation="Water depth at group. The elevation_scalar applies to this value.",
    )

    elevation_scalar = field(
        ScalarFactorField,
        offset=69,
        default=ScalarFactor.POS_1,
        documentation="""Scalar to be applied to the elevations and depths specified in:
    ...
    xy_scalar = field(
        ...
        offset=71,
        default=ScalarFactor.POS_1,
        documentation="""Scalar to be applied to all coordinates specified in source_x, source_y,
    ...
    source_x = field(
        ...
        offset=73,
        default=0,
        documentation="""Source coordinate - X. The xy_scalar applies to this value. The coordinate
    ...
    source_y = field(
        ...
        offset=77,
        default=0,
        documentation="""Source coordinate - Y. The xy_scalar applies to this value. The coordinate
        reference system should be identified through an extended header
        Location Data stanza. If the coordinate units are in seconds of arc,
    ...
    group_x = field(
        ...
        offset=81,
        default=0,
        documentation="""Group coordinate - X. The xy_scalar applies to this value. The coordinate
        reference system should be identified through an extended header
        Location Data stanza. If the coordinate units are in seconds of arc,
        decimal degrees or DMS, the X values represent longitude. A positive
        value designates east of Greenwich Meridian and a negative value
    ...
    group_y = field(
        ...
        offset=85,
        default=0,
        documentation="""Group coordinate - Y. The xy_scalar applies to this value. The coordinate
        reference system should be identified through an extended header
        Location Data stanza. If the coordinate units are in seconds of arc,
        decimal degrees or DMS, the Y values represent latitude. A positive
        value designates north of the equator and a negative value designates
    ...
    weathering_velocity = field(
        ...
        offset=91,
        default=0,
        documentation="Weathering velocity. (ft/s or m/s as specified in Binary File Header bytes 3255- 3256)",  # TODO
    )
    ...
    subweathering_velocity = field(
        ...
        offset=93,
        default=0,
        documentation="Subweathering velocity. (ft/s or m/s as specified in Binary File Header bytes 3255-3256)",  # TODO
    )
    ...
    uphole_time_at_source = field(
        ...
        offset=95,
        default=0,
        documentation="Uphole time at source in milliseconds. The time_scalar applies to this value.",
    )
    ...
    uphole_time_at_group = field(
        ...
        offset=97,
        default=0,
        documentation="Uphole time at group in milliseconds. The time_scalar applies to this value.",
    )
    ...
    source_static_correction = field(
        ...
        offset=99,
        default=0,
        documentation="Source static correction in milliseconds. The time_scalar applies to this value.",
    )
    ...
    group_static_correction = field(
        ...
        offset=101,
        default=0,
        documentation="Group static correction in milliseconds. The time_scalar applies to this value.",
    )
    ...
    total_static = field(
        ...
        offset=103,
        default=0,
        documentation="""Total static applied in milliseconds. (Zero if no static has been applied).
    ...
    lag_time_a = field(
        ...
        offset=105,
        default=0,
        documentation="""Lag time A. Time in milliseconds between end of 240-byte trace
    ...
    lag_time_b = field(
        ...
        offset=107,
        default=0,
        documentation="""Lag Time B. Time in milliseconds between time break and the initiation time
    ...
    delay_recording_time = field(
        ...
        offset=109,
        default=0,
        documentation="""Delay recording time — Time in milliseconds between initiation time of
    ...
    mute_start_time = field(
        ...
        offset=111,
        default=0,
        documentation="Mute time — Start time in milliseconds. The time_scalar applies to this value.",
    )
    ...
    mute_end_time = field(
        ...
        offset=113,
        default=0,
        documentation="Mute time — End time in milliseconds.  The time_scalar applies to this value.",
    )
    ...
    num_samples = field(
        ...
        offset=115,
        default=0,
        documentation="Number of samples in this trace. Highly recommended for all types of data.",
    )
    ...
    sample_interval = field(
        ...
        offset=117,
        default=0,
        documentation="""Sample interval in microseconds (μs) for this trace. The number of bytes in
    ...
    gain_type_of_field_instruments = field(
        ...
        offset=119,
        default=0,
        documentation="Gain type of field instruments. 1 = fixed, 2 = binary, 3 = floating point, 4 ... N = optional use.",
    )

    instrument_gain_constant = field(
        Int16, offset=121, default=0, documentation="Instrument gain constant (dB)."
    )
    ...
    correlated = field(
        CorrelatedField, offset=125, default=1, documentation=Correlated.__doc__
    )

    sweep_frequency_at_start = field(
        NNInt16, offset=127, default=0, documentation="Sweep frequency at start (Hz)."
    )

    sweep_frequency_at_end = field(
        NNInt16, offset=129, default=0, documentation="Sweep frequency at end (Hz)."
    )

    sweep_length = field(
        NNInt16, offset=131, default=0, documentation="Sweep length in milliseconds."
    )

    sweep_type = field(
        SweepTypeField, offset=133, default=0, documentation=SweepType.__doc__
    )
    ...
    taper_type = field(
        TaperTypeField, offset=139, default=0, documentation=TaperType.__doc__
    )
    ...
    alias_filter_slope = field(
        Int16, offset=143, default=0, documentation="Alias filter slope (dB/octave)."
    )
    ...
    notch_filter_slope = field(
        Int16, offset=147, default=0, documentation="Notch filter slope (dB/octave)."
    )

    low_cut_frequency = field(
        NNInt16, offset=149, default=0, documentation="Low-cut frequency (Hz), if used."
    )
    ...
    low_cut_slope = field(
        Int16, offset=153, default=0, documentation="Low-cut slope (dB/octave)."
    )

    high_cut_slope = field(
        Int16, offset=155, default=0, documentation="High-cut slope (dB/octave)."
    )
    ...
    year_recorded = field(
        ...
        offset=157,
        default=0,
        documentation="""Year data recorded. The 1975 standard is unclear as to whether this should
    ...
    day_of_year = field(
        DayOfYearField, offset=159, default=0, documentation=DayOfYearField.__doc__
    )

    hour_of_day = field(
        HourOfDayField, offset=161, default=0, documentation=HourOfDayField.__doc__
    )
    ...
    second_of_minute = field(
        SecondOfMinute, offset=165, default=0, documentation=SecondOfMinute.__doc__
    )

    time_basis_code = field(
        TimeBasisCodeField, offset=167, default=0, documentation=TimeBasisCode.__doc__
    )
    ...
    trace_weighting_factor = field(
        ...
        offset=169,
        default=0,
        documentation="Trace weighting factor. Defined as 2**-N volts for the least significant bit. (N = 0, 1, ..., 32767).",
    )
    ...
    geophone_group_num_first_trace_original_field = field(
        ...
        offset=173,
        default=0,
        documentation="Geophone group number of trace number one within original field record.",
    )
    ...
    geophone_group_num_last_trace_original_field = field(
        ...
        offset=175,
        default=0,
        documentation="Geophone group number of last trace within original field record.",
    )
    ...
    over_travel = field(
        OverTravelField, offset=179, default=0, documentation=OverTravel.__doc__
    )
...
class TraceHeaderRev1(TraceHeaderRev0):
    cdp_x = field(
        ...
        offset=181,
        default=0,
        documentation="""X coordinate of ensemble (CDP) position of this trace. The coordinate
        reference system should be identified through an extended header
    ...
    cdp_y = field(
        ...
        offset=185,
        default=0,
        documentation="""Y coordinate of ensemble (CDP) position of this trace. The coordinate
        reference system should be identified through an extended header
        Location Data stanza. The xy_scalar field applies to this value.""",
    )
    ...
    inline_number = field(
        ...
        offset=189,
        default=0,
        documentation="""In-line number for 3-D poststack data. If one in-line per SEG Y file is
    ...
    crossline_number = field(
        ...
        offset=193,
        default=0,
        documentation="""Cross-line number for 3-D poststack data. This will typically be the same
    ...
    shotpoint_number = field(
        ...
        offset=197,
        default=0,
        documentation="""Shotpoint number. This is probably only applicable to 2-D poststack data.
    ...
    shotpoint_scalar = field(
        ...
        offset=201,
        default=0,
        documentation="""Scalar to be applied to the shotpoint number in trace header field
    ...
    transduction_constant_mantissa = field(
        ...
        offset=205,
        default=0,
        documentation="""Transduction Constant mantissa. The mantissa of the multiplicative constant
    ...
    transduction_constant_exponent = field(
        ...
        offset=209,
        default=0,
        documentation="""Transduction Constant exponent. The base 10 exponent of the multiplicative
    ...
    transduction_units = field(
        ...
        offset=211,
        default=0,
        documentation="""Transduction Units. The unit of measurement of the Data Trace samples after
    ...
    device_trace_identifier = field(
        ...
        offset=213,
        default=0,
        documentation="""Device/Trace Identifier — The unit number or id number of the device
    ...
    time_scalar = field(
        ...
        offset=215,
        default=0,
        documentation="""Scalar to be applied to times specified in Trace Header fields
    ...
    source_type = field(
        SourceTypeField, offset=217, default=0, documentation=SourceTypeField.__doc__
    )
    ...
    source_energy_direction = field(
        ...
        offset=219,
        default=0,
        # TODO: This is six bytes. What is the format?
        documentation="""Source Energy Direction with respect to the source orientation. The positive
    ...
    source_measurement_mantissa = field(
        ...
        offset=225,
        default=0,
        documentation="""Source Measurement mantissa. Describes the source effort used to generate
    ...
    source_measurement_exponent = field(
        ...
        offset=229,
        default=0,
        documentation="""Source Measurement exponent. Describes the source effort used to generate
        the trace. The measurement can be simple, qualitative measurements such
        as the total weight of explosive used or the peak air gun pressure or
        the number of vibrators times the sweep duration. Although these simple
        measurements are acceptable, it is preferable to use true measurement
