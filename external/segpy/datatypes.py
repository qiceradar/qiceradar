...
SEG_Y_TYPE_TO_DATA_SAMPLE_FORMAT = {
    v: k for k, v in DATA_SAMPLE_FORMAT_TO_SEG_Y_TYPE.items()
}
...
def data_sample_format_size_in_bytes(data_sample_format: DataSampleFormat):
    ...
    return CTYPE_TO_SIZE[
        SEG_Y_TYPE_TO_CTYPE[DATA_SAMPLE_FORMAT_TO_SEG_Y_TYPE[data_sample_format]]
    ]
